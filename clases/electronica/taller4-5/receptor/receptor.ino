...
void trasmit(String &currentstate){
  for(int i=0;i<100;i++){
    if (currentstate=="Derecha"){
        Serial3.println("r");
        Serial.println("r");
      }
    if (currentstate=="Izquierda"){
      Serial3.println("l");
      Serial.println("l");
    }
    if (currentstate=="Tarea finalizada" || currentstate=="Detenido"){
      Serial3.println("s");
      Serial.println("s");
    }
  }
